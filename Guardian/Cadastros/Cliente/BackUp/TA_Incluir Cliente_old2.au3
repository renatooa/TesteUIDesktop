...
Send("^v" & " - Cliente Incluso - TESTE NFL{TAB 6}")
Opt("SendKeyDelay", 500) 									; Retorna o tempo padrão do SendKey

;--> Informa os dados do Endereço
Send("^b{ENTER}")
Opt("SendKeyDelay", 30) 									; Altera o tempo padrão do SendKey
Send("32315120" & "{ENTER 3}" & $v_numeroEndereco)
MouseClick("LEFT", 845, 328, 3)
Send("1{TAB 5}")
Send("email@email.com{TAB}{ENTER}")
