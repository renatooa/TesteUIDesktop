...
If WinExists("", "" & $v_textoTelaCadastro) Then
...
$v_codigoFormaPagto = InputBox("Código do Forma Pagto(Alteração)", "INFORME UM CÓDIGO DE FORMA DE PAGAMENTO! ..:", "", "", 300, 140)
