...
If WinExists("","Campo Obrigatório não preenchido ! Campo: Código") Then
	...
	WinActivate("","Campo Obrigatório não preenchido ! Campo: Código")
...
Func f_telaManutecaoEstoque()
	...
	If (WinExists("", "Manutenção de Endereços de Estoque")) Then
		...
		WinActivate("","Manutenção de Endereços de Estoque")
		Send("{ESC}{ENTER}")
