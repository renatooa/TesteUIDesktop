...
$frmIncluirDAV = GUICreate("Inclusão de DAV", 367, 263, 582, 128, -1, BitOR($WS_EX_TOPMOST,$WS_EX_WINDOWEDGE))
	...
	Switch $nMsg
		...
		Case $btnOk
		 ...
		 Else
			...
			MsgBox(48, "Erro", "Dado(s) para inclusão de DAV não Informado(s)!" &@CR&@CR& " A Rotina de teste será finalizada devido.")
			Exit
		 EndIf
