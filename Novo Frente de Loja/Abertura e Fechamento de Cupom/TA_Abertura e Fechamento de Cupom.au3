#cs ===============================================================================================================================
	...
	Descrição ......: Realiza a abertura e fechamento do cupom de forma automatizada.
	Data Inicio ....: 23/07/2015
	Data Termino ...: 03/08/2015
	Autor(s) .......: Ronildo
#ce ===============================================================================================================================
...
Local Const $v_codigoProduto = "82452"
Local Const $v_valorPago = "500,00"
...
Func f_mensagemPadrao()
	...
	$v_msgInicial = MsgBox(65, "Rotina de Teste Automatizado", "ESTÁ ROTINA IRÁ EXECUTAR O SEGUINTE TESTE " & @CR & @CR & _
			"Abertura e Fechamento de Cupom")
