#cs ===============================================================================================================================
	...
	Descrição ......: Efetuar a alteração de Cliente e Vendedor Antes da abertura e fechamento do cupom no sistema NFL
...
; Abre a tela de Dados Adicionais
Send("!{F2}")
Sleep(2000)

; Passa o código de Cliente
MouseClick("left", 353, 134, 2)
Send($v_codigoCliente & "{TAB}")

; Passa o código de Vendedor
Sleep(1000)
MouseClick("Left", 353, 249, 2)
Send($v_codigoVendedor & "{TAB}")
Sleep(2000)
Send("{ESC}")
...
Func f_mensagemPadrao()
	...
	$v_msgInicial = MsgBox(65, "Rotina de Teste Automatizado", "ESTÁ ROTINA IRÁ EXECUTAR O SEGUINTE TESTE " & @CR & @CR & _
			"Alterar Cliente e Vendedor Antes de Abrir e Fechar Cupom")
