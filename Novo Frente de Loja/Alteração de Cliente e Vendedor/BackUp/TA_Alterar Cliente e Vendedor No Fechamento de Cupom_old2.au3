#cs ===============================================================================================================================
	...
	Descrição ......: Efetuar a alteração de Cliente e Vendedor NO fechamento do cupom no sistema NFL
...
Func f_mensagemPadrao()
	...
	$v_msgInicial = MsgBox(65, "Rotina de Teste Automatizado", "ESTÁ ROTINA IRÁ EXECUTAR O SEGUINTE TESTE " & @CR & @CR & _
			"Alterar Cliente e Vendedor no Fechamento de Cupom")
