#cs ===============================================================================================================================
	...
	Descrição ......: Rotina para alterar o vendedor antes de efetuar a abertura e fechamento do cupom no sistema NFL.
...
; Abre a tela de Dados Adicionais e seleciona o campo de vendedor
Send("!{F2}")
Sleep(2000)
...
Func f_mensagemPadrao()
	...
	$v_msgInicial = MsgBox(65, "Rotina de Teste Automatizado", "ESTÁ ROTINA IRÁ EXECUTAR O SEGUINTE TESTE " & @CR & @CR & _
			"Alterar Vendedor Antes de Abrir e Fechar Cupom")
