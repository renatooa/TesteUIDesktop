...
#include-once
#Region Constant
Global Const $_MB_OK_TEXT = 'OK'
Global Const $_MB_CANCEL_TEXT = 'Cancelar'
Global Const $_MB_YES_TEXT = 'Sim'
Global Const $_MB_NO_TEXT = 'Não'
Global Const $_MB_Abort_TEXT = 'About'
Global Const $_MB_Retry_TEXT = 'Retry'
Global Const $_MB_Ignore_TEXT = 'Ignore'
Global Const $_MB_Again_TEXT = 'Again'
Global Const $_MB_Continue_TEXT = 'Continuar'
#EndRegion Constant
